...
composer remove drupal/webform_views:^5.0 drupal/entity_print:^2.7 drupal/core drupal/ldap:4.3 drupal/devel drupal/console drupal/core webflo/drupal-finder drupal-composer/drupal-scaffold --no-update
...
drush sql-query "drop table groups_field_revision;"
